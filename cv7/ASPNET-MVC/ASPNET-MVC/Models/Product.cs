	...
	public static List<Product> GetProducts() {
		return new List<Product>() {
			new Product() {
				...
				Name = "77\" LG OLED77B2",
				Description
					= "Televize SMART OLED, 195cm, 4K Ultra HD, 100Hz, HDR10, HLG, Dolby Vision, DVB-T2/S2/C, H.265/HEVC, 4× HDMI, 2× USB, CI+, USB nahrávání, LAN, WiFi, Bluetooth, DLNA, Miracast, HbbTV 2.0, herní režim, hlasové ovládání, Netflix, Disney+, HBO Max, Apple TV, Voyo, O2 TV, Google Assistent, Přehrávání 360° videa, Amazon Alexa, Apple Airplay 2, párování s mobilním zařízením, WebOS, VESA 400×200, repro 20W, Dolby Atmos, Ultra Surround, en. třída F",
				Price = 49_990,
			...
			new Product() {
				...
				Description
					= "Horské kolo 29\" - karbonový rám, 12 rychlostí, vzduchová vidlice ROCKSHOX JUDY silver TK 29 tapered (zdvih 100 mm), brzdy SHIMNAO SLX, BL-M7100, hmotnost 11,9 kg",
				Price = 44_790,
